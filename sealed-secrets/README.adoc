...
== Installation
I'm using a bash script to download the controller file, then using kustomize i modify some security context attributes. Then it download kubeseal utility
